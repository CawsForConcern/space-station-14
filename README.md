...
## License
Featherlight is a minor fork with just small tweaks.
All direct contributions to Featherlight are MIT.
Any content contributed to Starlight is under its original license, detailed below:
